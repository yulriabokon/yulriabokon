...
This repository contains SQL queries used to analyze crime data from the Chicago Police Department. The data is sourced from the BigQuery Public Dataset `bigquery-public-data.chicago_crime.crime`.
